...
@interface TaskParentSearchVC ()<NetworkPtc, UIAlertViewDelegate>
...
@implementation TaskParentSearchVC
...
-(void)searchBarTextDidBeginEditing:(UISearchBar *)searchBar
{
    ...
    for (UIView *searchbuttons in [searchBar subviews])
    {
        if ([searchbuttons isKindOfClass:[UIButton class]])
        {
            ...
            [cancelButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];						// 修改按钮背景
...
{
//    // 过滤结果
//    if (tableView == _strongSearchDisplayController.searchResultsTableView)
//    {
